...
1. **Alternative horizons (1-3d)**: cross-sectional momentum / reversal at
   ...
   **→ CLOSED 2026-06-10** — see
   [short_horizon_reversal.md](short_horizon_reversal.md). Reversal is
   statistically real (rev3 cs-IC +0.0195, t=6.3 on PIT panel) but no
   candidate survives 15bp one-way costs at daily turnover. Next-day
   per-stock direction is a dead end at retail costs; only viable reuse
   is as a cost-free entry-timing overlay on the 20d engine.
